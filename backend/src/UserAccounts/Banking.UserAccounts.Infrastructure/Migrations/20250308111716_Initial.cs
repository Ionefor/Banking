        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_corporate_accounts_asp_net_users_user_id",
                        column: x => x.user_id,
                        principalSchema: "user_accounts",
                        principalTable: "users",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_individual_accounts_asp_net_users_user_id",
                        column: x => x.user_id,
                        principalSchema: "user_accounts",
                        principalTable: "users",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_corporate_accounts_user_id",
                schema: "user_accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_individual_accounts_user_id",
                schema: "user_accounts",
