        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!Guid.TryParse(userIdString, out Guid userId))
        {
            return Errors.General.ValueIsRequired(
                    new ErrorParameters.ValueIsRequired(nameof(CustomClaims.Id))).ToErrorList();
        }
        ...
        {
            return Errors.General.ValueIsRequired(
                    new ErrorParameters.ValueIsRequired(nameof(CustomClaims.Jti))).ToErrorList();
        }
        
        if (oldRefreshSession.Value.UserId != userId)
        {
            return Errors.General.ValueIsInvalid(
                new ErrorParameters.ValueIsInvalid(nameof(oldRefreshSession.Value.UserId))).
                ToErrorList();
        }
        ...
        {
            return Errors.General.ValueIsInvalid(
                new ErrorParameters.ValueIsInvalid(nameof(oldRefreshSession.Value.Jti))).
                ToErrorList();
        }
