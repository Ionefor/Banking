...
public class RegisterCorporateAccountHandler :
    ICommandHandler<RegisterCorporateAccountCommand>
{
    private readonly IValidator<RegisterCorporateAccountCommand> _validator;
    private readonly IAccountsContract _contract;
    private readonly UserManager<User> _userManager;
    private readonly RoleManager<Role> _roleManager;
    private readonly ILogger<RegisterCorporateAccountHandler> _logger;
    private readonly IUnitOfWork _unitOfWork;

    public RegisterCorporateAccountHandler(
        IValidator<RegisterCorporateAccountCommand> validator,
        UserManager<User> userManager,
        RoleManager<Role> roleManager,
        IAccountsContract contract,
        ILogger<RegisterCorporateAccountHandler> logger,
    ...
    public async Task<UnitResult<ErrorList>> Handle(
        RegisterCorporateAccountCommand command,
        ...
        try
        {
            ...
            if (corporateRole is null)
            {
                return Errors.General.NotFound(new ErrorParameters.NotFound(
                        nameof(Role), nameof(Constants.Accounts.Corporate),
