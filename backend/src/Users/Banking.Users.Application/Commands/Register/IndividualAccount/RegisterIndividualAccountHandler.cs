...
public class RegisterIndividualAccountHandler :
    ICommandHandler<RegisterIndividualAccountCommand>
{
    private readonly IValidator<RegisterIndividualAccountCommand> _validator;
    private readonly IAccountsContract _contract;
    private readonly UserManager<User> _userManager;
    private readonly RoleManager<Role> _roleManager;
    private readonly ILogger<RegisterIndividualAccountHandler> _logger;
    private readonly IUnitOfWork _unitOfWork;

    public RegisterIndividualAccountHandler(
        IValidator<RegisterIndividualAccountCommand> validator,
        UserManager<User> userManager,
        RoleManager<Role> roleManager,
        IAccountsContract contract,
        ILogger<RegisterIndividualAccountHandler> logger,
    ...
    public async Task<UnitResult<ErrorList>> Handle(
        RegisterIndividualAccountCommand command,
        ...
        try
        {
            ...
            if (individualRole is null)
            {
                return Errors.General.NotFound(
                    new ErrorParameters.NotFound(nameof(Role), nameof(Constants.Accounts.Individual),
